...
<body>
    ...
    <div class=\"choix_client\">
        ...
        <p>Cliquez sur <strong>Liste Clients</strong> pour afficher la liste de tous les clients non salariés</p>
        <div id=\"select_client\">
            ...
            <button id=\"affiche_liste_client_non_salarie\" name=\"affiche_liste_client_non_salarie\" onclick=\"affiche_liste_client_non_salarie()\">Liste Clients</button>
        </div>
        <form id=\"saisie_id_client\" action=\"";
        // line 28
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("recherche_client_non_salarie");
        echo "\" method=\"POST\">
    ...
    ";
        // line 38
        echo "    <div  id=\"liste_client_non_salarie\" class=\"container\">
        <div class=\"row\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["clientNonSalarie"]) || array_key_exists("clientNonSalarie", $context) ? $context["clientNonSalarie"] : (function () { throw new RuntimeError('Variable "clientNonSalarie" does not exist.', 51, $this->source); })()));
    ...
    <form id=\"form_compte_non_salarie\" action=\"";
        // line 72
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_client_non_salarie");
        echo "\" method=\"post\" onsubmit=\"return verifie_formulaire_non_salarie(this)\">
...
\t\t\t\t\t</select>
    ...
    {
        return array (  238 => 167,  140 => 72,  135 => 69,  129 => 59,  120 => 56,  116 => 55,  112 => 54,  108 => 53,  105 => 52,  101 => 51,  86 => 38,  76 => 28,  55 => 10,  52 => 9,  43 => 1,);
    }
...
<body>
    ...
    <div class=\"choix_client\">
        ...
        <form id=\"saisie_id_client\" action=\"{{ path('recherche_client_non_salarie')}}\" method=\"POST\">
            <input type=\"search\" id=\"identifiant_client\" name=\"identifiant_client\" placeholder=\"identifiant client\" />
            <input type=\"submit\" name=\"search\" id=\"search\" value=\"Search\" />
        </form>
    </div>
    ...
    {# <div class=\"accueil_responsable\">
        <a href=\"{{ path('add_client_non_salarie')}}\">Ajouter un client non Salarié</a>
    </div> #}
    <div  id=\"liste_client_non_salarie\" class=\"container\">
        <div class=\"row\">
            <div class=\"col-md-1\"></div>
            <div class=\"card col-md-10\">
                <div class=\"card-header text-center font-weight-bold\">Liste Clients Non Salariés</div>
    ...
    <form id=\"form_compte_non_salarie\" action=\"{{ path('add_client_non_salarie')}}\" method=\"post\" onsubmit=\"return verifie_formulaire_non_salarie(this)\">
